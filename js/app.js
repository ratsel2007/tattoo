(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".valentine__slider")) new core(".valentine__slider", {
            ...
            if (document.querySelector(".who__slider")) new core(".who__slider", {
                ...
                navigation: {
                    nextEl: ".who-slider__arrow_next",
                    prevEl: ".who-slider__arrow_prev"
                },
                on: {}
            });
            if (document.querySelector(".features__slider")) new core(".features__slider", {
                ...
                navigation: {
                    nextEl: ".slider-features__arrow_next",
                    prevEl: ".slider-features__arrow_prev"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".success__slider")) new core(".success__slider", {
                ...
                navigation: {
                    nextEl: ".success__arrow_next",
                    prevEl: ".success__arrow_prev"
                },
                on: {}
            });
        }
        ...
        function movies() {
            ...
            new ScrollMagic.Scene({
                ...
                duration: 7e3,
                triggerHook: 0
            }).setTween(timelineMain).setPin(".main").addTo(controller);
            const timelineAbout = new TimelineMax;
            timelineAbout.from(".about__body", {
                opacity: 0,
                y: 200,
                duration: 1,
                ease: Linear.easeNone
            ...
            new ScrollMagic.Scene({
                ...
                duration: 6e3,
                triggerHook: 0
            }).setTween(timelineAbout).setPin(".about").addTo(controller);
            new ScrollMagic.Scene({
                triggerElement: ".what-title",
                duration: 1e3,
                triggerHook: 0
            }).setPin(".what-title").addTo(controller);
            if (window.innerWidth >= 768) {
                const timelineWhat = new TimelineMax;
                timelineWhat.from(".what__image-ibg", {
                    scale: .8,
                    duration: 1,
                    ease: Linear.easeNone
                }).from(".item-what", {
                ...
                new ScrollMagic.Scene({
                    ...
                    duration: 5e3,
                    triggerHook: 0
                }).setTween(timelineWhat).setPin(".what").addTo(controller);
            }
            new ScrollMagic.Scene({
                triggerElement: ".who",
                duration: 1e3,
                triggerHook: 0
            }).setPin(".who").addTo(controller);
            if (window.innerWidth >= 768) {
                const timelineFeatures = new TimelineMax;
                timelineFeatures.from(".features__slider", {
                    opacity: 0,
                    y: 300,
                    duration: 1,
                    ease: Linear.easeNone
                ...
                new ScrollMagic.Scene({
                    ...
                    duration: 2e3,
                    triggerHook: 0
                }).setTween(timelineFeatures).setPin(".features").addTo(controller);
            }
            const timelineReady = new TimelineMax;
            timelineReady.to(".ready", {
                scale: .6,
                y: -300,
                duration: 1,
                ease: Linear.easeNone
            ...
            new ScrollMagic.Scene({
                ...
                duration: 2e3,
                triggerHook: 0
            }).setTween(timelineReady).setPin(".ready").addTo(controller);
            const timelineCourses = new TimelineMax;
            timelineCourses.from(".courses__body", {
                opacity: 0,
                y: 300,
                duration: 1,
                ease: Linear.easeNone
            }).from(".item-courses__label", {
                opacity: 0,
                duration: 1,
                delay: 1,
                ease: Linear.easeNone
            ...
            new ScrollMagic.Scene({
                triggerElement: ".courses",
                duration: 2e3,
                triggerHook: 0
            }).setTween(timelineCourses).setPin(".courses").addTo(controller);
            const timelineSuccess = new TimelineMax;
            timelineSuccess.from(".success__wrapper", {
                opacity: 0,
                y: 300,
                duration: 1,
                ease: Linear.easeNone
            }).from(".success__wrapper", {
                duration: 1,
                ease: Linear.easeNone
            });
            new ScrollMagic.Scene({
                ...
                duration: 2e3,
                triggerHook: 0
            }).setTween(timelineSuccess).setPin(".success").addTo(controller);
            const timelineInstagram = new TimelineMax;
            timelineInstagram.from(".instagram__body", {
                opacity: 0,
                y: 300,
                duration: 1,
                ease: Linear.easeNone
            }).from(".instagram__body", {
                duration: 1,
                ease: Linear.easeNone
            });
            new ScrollMagic.Scene({
                ...
                duration: 2e3,
                triggerHook: 0
            }).setTween(timelineInstagram).setPin(".instagram").addTo(controller);
        }
